<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Biblethon.Master"
    CodeBehind="BiblethonOrderEntry.aspx.cs" Inherits="Biblethon.BiblethonOrderEntry" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="divMain">
        <asp:Label ID="lblError" Style="color:Red; margin-left:170px; visibility:hidden;" runat="server" Text=""></asp:Label></div>
                    ...
                    <td>
                        <asp:GridView ID="gdvOfferLine" Width="700px" AutoGenerateColumns="false" CssClass="gridId"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Total">
                                    <ItemTemplate>
                                        <asp:TextBox ID="LBLSubTotal" Style="text-align: right; border-width:0px; border-collapse:collapse; background-color:#edf8f8;" runat="server" ForeColor="Green" Text="$0.00"></asp:TextBox>
                                    </ItemTemplate>
            ...
            <table style="width: 700px;">
                <tr>
                    ...
                    <td align="right" style="width: 150px">
                        ...
                        <asp:TextBox ID="lblTotal" runat="server" Text="" Style="text-align: right; border-width:0px; border-collapse:collapse; background-color:#edf8f8;"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td align="right" style="width: 150px">
                        <asp:TextBox ID="lblGrandTotal" runat="server" Style="text-align: right; border-width:0px; border-collapse:collapse; background-color:#edf8f8;"></asp:TextBox>
                    </td>
                </tr>
                <tr>
        ...
        <div class="divAccordian">
            <table  style="width:700px;">
                ...
                <tr style="height:45px;color:Red;">
                    ...
                    <td><asp:TextBox ID="txtCreditCardNo" runat="server" Width="152px" />
                    </td>
                    <td style="color:Red;">CVN
                    </td>
                    <td><asp:TextBox ID="txtCVN" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="text-align:right">
                        <asp:Button ID="btnBack4" runat="server" OnClientClick="GetBack(this)" Text="<< Back" /><asp:Button
                            ID="btncontinue4" runat="server" Text="Continue" 
                            onclick="btncontinue4_Click" />
                    </td>
                </tr>
            </table>
        </div>
                ...
                <tr>
                    <td colspan="4" style="text-align:right">
                        <asp:Button ID="btnBack5" runat="server" OnClientClick="GetBack(this)" Text="<< Back" />&nbsp;&nbsp;<asp:Button
                            ID="btnSaveOrder" runat="server" Text="Save" Width="63px" 
                            onclick="btnSaveOrder_Click" />&nbsp;&nbsp;<asp:Button ID="btnProcessOrder" runat="server"
                                Text="Process" Width="74px" />
                    </td>
                </tr>
            </table>
        </div>
